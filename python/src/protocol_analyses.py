...
sc.plots.plot_cond_means_multiple_measures(exp1, dependent_vars=['PMissingWords', 'PMissingDigits', 'PMissingClasses'],
                                           ...
                                           dependent_var_names=('Word errors', 'Digit errors', 'Class errors'), colors=GREENS, font_size=8)
'''
...
sc.plots.plot_cond_means_multiple_measures(exp2, dependent_vars=['PMissingWords', 'PMissingDigits', 'PMissingClasses'],
                                           ...
                                           dependent_var_names=('Word errors', 'Digit errors', 'Class errors'), colors=GREENS[1:], font_size=8)
...
#-- (PStat:FigExp2Conds)
sc.plots.plot_cond_means_multiple_measures(exp3, dependent_vars=['PMissingWords', 'PMissingDigits', 'PMissingClasses'],
                                           ...
                                           dependent_var_names=('Word errors', 'Digit errors', 'Class errors'), colors=(GREEN, RED), font_size=8)
...
sc.plots.plot_cond_means_multiple_measures(exp4, dependent_vars=['PMissingWords', 'PMissingDigits', 'PMissingClasses'],
